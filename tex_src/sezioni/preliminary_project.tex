...
\begin{enumerate}
    \item Te user will launch the plugin.
    \item The plugin will ask for the credentials of the database fig:[\ref{optuTorial1}]. 
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{img/op1.png} \caption{Database login} \label{optuTorial1}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{img/op2.png} \caption{Report selection} \label{optuTorial2}
    \end{figure}

    \item The plugin will find the nearest tree monitor units to the report (two uptream one downstram) and they will be conetted to the report choseen fig:[\ref{optuTorial3}].
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{img/op3.png} \caption{Report connetions} \label{optuTorial3}
    \end{figure}

    \item The plugin will find all the report in a range of 500m and they will be conetted to the report choseen.
  \end{enumerate}
