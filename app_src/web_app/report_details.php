...
<body>
  ...
  <?php
    ...
    echo "<input type=\"hidden\" id=\"lat\" value=\"" . $coordinates[0] . "\">";
    echo "<input type=\"hidden\" id=\"long\" value=\"" . $coordinates[1] . "\">";
...
<div class="accordion" id="collapseExample">
  ...
  <div class="accordion-item">
    ...
    <div id="collapse2c" class="accordion-collapse collapse show" role="region" aria-labelledby="heading2c">
      <div class="accordion-body">
      <?php echo date("d/m/Y", strtotime($arr[1])); ?>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    <h2 class="accordion-header " id="heading3c">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3c" aria-expanded="false" aria-controls="collapse3c">
        Descrizione
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header " id="heading4c">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4c" aria-expanded="false" aria-controls="collapse4c">
        Immagine
      </button>
    </h2>
    <div id="collapse4c" class="accordion-collapse collapse show" role="region" aria-labelledby="heading4c">
      <div class="accordion-body">
        <?php 
            if ($arr[5] != NULL) {
                echo "<img src=\"images/" . $arr[5] . "\" style=\"max-width: 20em;\"/>";
            }
            else {
  ...
  <div class="accordion-item">
    <h2 class="accordion-header " id="heading5c">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5c" aria-expanded="false" aria-controls="collapse5c">
        Elevazione
      </button>
    </h2>
    <div id="collapse5c" class="accordion-collapse collapse show" role="region" aria-labelledby="heading5c">
      <div class="accordion-body">
        <?php echo number_format($arr[6], 2); ?> metri s.l.m.
      </div>
    </div>
  </div>
</div>
